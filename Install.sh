...
#FILE1=$(find /opt/codedeploy-agent/deployment-root/ -name LoginWebApp-1.war -exec ls -tr {} \;| tail -1)
#echo $FILE1
#cp $FILE1 /data/apache-tomcat-9.0.54/webapps/
#ls -ltr /data/apache-tomcat-9.0.54/webapps/LoginWebApp-1.war
#systemctl restart tomcat
